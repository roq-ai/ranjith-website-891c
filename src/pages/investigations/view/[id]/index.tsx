...
import { getInvestigationById } from 'apiSdk/investigations';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('investigation', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/investigations/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('report', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/reports/create?investigation_id=${data?.id}`}>
                    ...
                    <Table variant="simple">
                      ...
                      <Tbody>
                        {data?.report?.map((record) => (
                          <Tr
                            cursor="pointer"
                            onClick={() => router.push(`/reports/view/${record.id}`)}
                            key={record.id}
                          >
